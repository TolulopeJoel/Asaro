...
export const MILESTONE_BADGES: Badge[] = [
    {
        ...
        emoji: '✨',
        label: 'First Entry',
        desc: 'made their very first journal entry in the group!',
        order: 1,
    },
    {
        id: 'entries_10',
    ...
    },
    {
        ...
        desc: 'shared their first reflection with the group!',
        order: 4,
    },
];
...
export const GROUP_BADGES: Array<Badge & { threshold: number }> = [
    ...
    },
    {
        ...
        desc: 'The group read EVERY DAY for a whole month — legendary!',
        order: 21,
        threshold: 30,
    },
    {
        ...
        desc: 'Every member in the group read today — amazing!',
        order: 22,
        threshold: 0,
    },
];
