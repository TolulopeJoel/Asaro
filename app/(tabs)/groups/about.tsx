...
export default function AboutGroupsScreen() {
    ...
    const sections = [
        ...
        {
            title: 'A FRESH START',
            subtitle: 'Everything resets on the 1st',
        ...
        {
            title: 'ADMIN BIO',
            subtitle: 'Say who you are. Briefly.',
        ...
        {
            title: 'NAME CHANGE',
            subtitle: 'Three months, then you pick',
        ...
        {
            title: 'CREATE GROUP',
            subtitle: 'Half the Bible, then you can start one',
